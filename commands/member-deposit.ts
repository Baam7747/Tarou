                ...
                if (!interaction.options.getString('cancel')) {
                    ...
                    { nations(id: ${docs[0].nationID}, first: 1)
                        ...
                        for (let i = 0; i < data.nations.data[0].bankrecs.length; i++) {
                            if ((data.nations.data[0].bankrecs[i].note === docs[0].deposit_code) && ((data.nations.data[0].bankrecs[i].recipient_id == 10060) || (data.nations.data[0].bankrecs[i].recipient_id == 8594))) {
                    ...
                    userInfo.update({ discordID: discordid },
                        ...
                        interaction.reply("Your deposit process has been cancelled!")

                } else if (interaction.options.getString('cancel') == ("false")) {
                    interaction.reply(`Why you waste my time if you no cancel your deposit process <:yotsuBruh:986092690527633429>`)
                }
            })
        })
    }
